...
/*!
 * This function adds new columns to a GtkTreeView.
 * @param grid Pointer to the GtkTreeView object.
 * @param names A null-terminated array containing the names of the columns.
 * @param renderer The GtkCellRender used to render the cells.
 */
void fbs_gtk_tree_view_create_columns(GtkTreeView *grid,
			const char *names[], GtkCellRenderer *renderer);

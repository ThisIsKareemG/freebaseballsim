...
#ifndef BASEBALL_CONSTANTS_H
#define BASEBALL_CONSTANTS_H

const static int GAMES_PER_SERIES = 3;
const static int DEFAULT_QUERY_LENGTH = 500;
const static int MAX_PATH_LENGTH = 256;

#endif /* BASEBALL_CONSTANTS_H */
